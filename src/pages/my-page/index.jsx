...
const MyPage = () => {
  ...
  const dummyArr = {
    profileImg:
      'https://live.staticflickr.com/65535/51810835192_5b77f55db2_o.jpg',
    nickname: 'adsada',
    ...
    postList: [
      ...
      },
      {
        ...
        title: '이서',
        thumbnail_img_url:
          'https://news.nateimg.co.kr/orgImg/tv/2022/09/02/1662097003_1652481.jpg',
        nickname: 'yangjaehyuk_',
      },
      {
        postId: 5,
      ...
      },
      {
        ...
        title: '리즈',
        thumbnail_img_url:
          'https://live.staticflickr.com/65535/51920730501_f72be62735_o.jpg',
        nickname: 'yangjaehyuk_',
      },
    ],
  };
  useEffect(() => {
    ...
    dummyArr.postList.forEach((post) => {
      post.nickname = dummyArr.nickname;
    });
  }, []);
  return (
    <Wrapper>
      ...
      <SubContainer>
        <Inner>
          ...
          <div style={{ margin: '0 auto' }}>
            <ProfileContainer src={dummyArr.profileImg} alt="asd" />
          </div>
        </Inner>
      </SubContainer>
      <SubContainer>
      ...
      <SubContainer>
        <Inner>
          ...
          <SearchPagination arr={dummyArr.postList} pageSize={4} />
        </Inner>
      </SubContainer>
    </Wrapper>
  );
